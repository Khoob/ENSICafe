...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 02 juin 2017 à 14:43
...
INSERT INTO `actu` (`id`, `type`, `date`, `contenu`, `nbLike`, `nbDislike`) VALUES
(1, 'Actu', '2017-05-31 13:56:00', 'Premier remplissage de la base de données', 1, 0);
...
INSERT INTO `clubs` (`id`, `nom`, `description`, `photo`) VALUES
(1, 'XID', 'Club Informatique', ''),
(2, 'Club JDR', 'Club de jeux de rôles', '');
...
INSERT INTO `message` (`id`, `dateEnvoi`, `contenu`) VALUES
(1, '2017-06-02 11:00:00', 'Coucou'),
(2, '2017-06-02 11:53:50', 'test');
...
(1, 'Blangero', 'Thomas', 'thomas.blangero@uha.fr', '1995-11-10', 'Homme', 'Etudiant', 'mdp', 'PCSI/PSI', '', '', 0),
...
(5, 'Tinh', 'Olivier', 'olivier.tinh@uha.fr', '1995-03-24', 'Homme', 'Etudiant', 'ensisa', '', '', '', 0);
